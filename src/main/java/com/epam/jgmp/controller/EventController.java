...
import com.epam.jgmp.controller.dto.EventDTO;
...
public class EventController {
  ...
  public Event createEvent(@RequestBody EventDTO eventDTO) {
    ...
    Event event = new Event(eventDTO.getTitle(), eventDTO.getDate(), eventDTO.getTicketPrice());

    return bookingFacade.createEvent(event);
  }

  @PutMapping("/update/{id}")
  public Event updateEvent(@RequestBody EventDTO eventDTO, @PathVariable Long id) {
